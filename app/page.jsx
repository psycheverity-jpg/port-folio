...
export default function Portfolio() {
  ...
  return (
    <div className="px-6 sm:px-12 md:px-24 py-8 max-w-[1600px] mx-auto font-sans selection:bg-white selection:text-black">
      ...
      <motion.section variants={stagger} initial="hidden" animate="visible" className="pb-24 border-b border-kexBorder">
        <motion.h1 variants={fadeInUp} className="text-4xl sm:text-6xl md:text-[5rem] font-medium leading-[1.08] tracking-tight text-white mb-12">
          Managing <span class="text-kexDim italic font-light">( retail ops )</span>, 
          <span class="text-kexDim italic font-light">( hardware )</span>, <br className="hidden md:block" />
          <span class="text-kexDim italic font-light">( administration )</span> & 
          <span class="text-kexDim italic font-light">( production SOP )</span>
        </motion.h1>
      ...
      <section id="experience" className="py-24 border-b border-kexBorder">
        ...
        <div className="space-y-24">
          ...
          >
            ...
            <div className="lg:col-span-8 bg-kexCard border border-kexBorder p-6 sm:p-8 rounded-2xl">
      ...
      {/* SKILLS SECTION */}
      <section id="skills" class="py-24 border-b border-kexBorder">
        <motion.div 
          initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeInUp}
          className="mb-16"
        >
        ...
        >
          <motion.div variants={fadeInUp} className="p-6 bg-kexCard border border-kexBorder rounded-xl">
      ...
      <section id="about" className="py-24 border-b border-kexBorder">
        ...
        >
          <div className="lg:col-span-5">
            ...
            <h2 class="text-2xl text-white font-medium mb-4">Pendidikan Formal</h2>
            <div className="p-6 bg-kexCard border border-kexBorder rounded-xl font-mono text-xs">
      ...
      <footer id="contact" className="pt-24 pb-12">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}>
          ...
          <div className="flex flex-col sm:flex-row gap-6 font-mono text-sm mb-24">
            <a 
              href="mailto:bayuandk4@gmail.com" 
              className="px-6 py-4 bg-kexCard border border-kexBorder rounded-xl text-white hover:border-zinc-500 transition-colors flex items-center gap-3"
            >
              <span>✉</span> bayuandk4@gmail.com
            </a>
            <a 
              href="https://wa.me/6287881820662" 
              target="_blank" 
              rel="noreferrer" 
              className="px-6 py-4 bg-kexCard border border-kexBorder rounded-xl text-white hover:border-zinc-500 transition-colors flex items-center gap-3"
            >
            ...
            <a 
              href="https://linkedin.com/in/bayu-andika2003/" 
              target="_blank" 
              rel="noreferrer" 
              className="px-6 py-4 bg-kexCard border border-kexBorder rounded-xl text-white hover:border-zinc-500 transition-colors flex items-center gap-3"
            >
